...
const COURSES_DATA: Course[] = [
  { id: '1', title: '大数据分析', description: '掌握 Hadoop、Spark 和数据可视化技术。', category: '数据科学', thumbnail: 'https://picsum.photos/600/400?random=1', lessons: 42, duration: '12小时', difficulty: '高级' },
  { id: '2', title: '云计算基础', description: 'AWS、Azure 和私有云基础设施介绍。', category: '云计算', thumbnail: 'https://picsum.photos/600/400?random=2', lessons: 28, duration: '8小时', difficulty: '中级' },
  { id: '3', title: '物联网传感器网络', description: '将物理世界连接到数字领域。', category: '物联网', thumbnail: 'https://picsum.photos/600/400?random=3', lessons: 15, duration: '5小时', difficulty: '初级' },
  { id: '4', title: 'Python 自动化运维', description: '编写脚本解决系统管理的实际问题。', category: '编程', thumbnail: 'https://picsum.photos/600/400?random=4', lessons: 30, duration: '10小时', difficulty: '初级' },
  { id: '5', title: '网络安全防御', description: '防御现代网络威胁和漏洞。', category: '安全', thumbnail: 'https://picsum.photos/600/400?random=5', lessons: 50, duration: '15小时', difficulty: '高级' },
  { id: '6', title: '工业机器人', description: '自动化装配线的编程与维护。', category: '工程', thumbnail: 'https://picsum.photos/600/400?random=6', lessons: 20, duration: '6小时', difficulty: '中级' },
];
