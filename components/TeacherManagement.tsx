...
const TeacherManagement: React.FC = () => {
  ...
  const teachers: TeacherData[] = [
    { id: 1, name: "小陈", phone: "18259183416", org: "物联网", status: true },
    { id: 2, name: "林连杰", phone: "15806025022", org: "新大陆大学", status: true },
    { id: 3, name: "阅卷老师002", phone: "19859100023", org: "考试班级", status: true },
    { id: 4, name: "阅卷老师001", phone: "19859100022", org: "考试班级", status: true },
    { id: 5, name: "杨克强", phone: "18960921912", org: "新大陆大学", status: true },
    { id: 6, name: "张明辉", phone: "15306915029", org: "新大陆大学", status: true },
    { id: 7, name: "农大test", phone: "13805911001", org: "新大陆大学", status: true },
  ];
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="px-4 py-3 text-sm font-bold text-slate-700">教师姓名</th>
            ...
            <tbody>
              {teachers.map((t, idx) => (
                <tr key={t.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="px-4 py-3 text-sm text-slate-600">{t.org}</td>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs font-medium ${t.status ? 'text-blue-600' : 'text-slate-400'}`}>
                        {t.status ? '启用' : '禁用'}
                      </span>
                    </div>
                  </td>
